...
namespace SuperTestLibrary.Services.Generators
{
    public class EvaluateSpecFlowScenarioGenerator : GeneratorBase
    {
        ...
        protected override string JsonPromptClaude35Sonnet => "Services/Prompts/EvaluateSpecFlowScenario/Claude_3_5_Sonnet.json";
        protected override string JsonPromptGPT4o => "Services/Prompts/EvaluateSpecFlowScenario/GPT_4o.json";
