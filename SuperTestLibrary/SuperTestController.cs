...
namespace SuperTestLibrary
{
    public class SuperTestController : ISuperTestController
    {
        ...
        public async Task<SpecFlowFeatureFileResponse> GenerateSpecFlowFeatureFileAsync(string requirements)
        {
            ...
            var specFlowFeatureFile = GetSpecFlowFeatureFileResponse.ConvertJson(response.ResponseJson);
        ...
        public async Task<SpecFlowBindingFileResponse> GenerateSpecFlowBindingFileAsync(string featureFile, Dictionary<string, string> generatedCSharpCode)
        {
            ...
            var specFlowBindingFile = GetSpecFlowBindingFileResponse.ConvertJson(response.ResponseJson);
        ...
        private async Task<GeneratorResponse> GenerateAsync()
        {
            ...
            var response = await SelectedGenerator!.GenerateAsync(SelectedLLM!);
        ...
        where TConverter : class
        {
            ...
            var responseJson = await GenerateAsync();
            ...
            try
            {
                ...
                var response = (TResponse)typeof(TConverter).GetMethod("ConvertJson")!.Invoke(null, [responseJson.ResponseJson])!;
